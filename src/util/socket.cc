...
// $Id: socket.cc,v 1.1 2006/04/07 01:33:24 eric_mcdonald Exp $
...
/*! \file
    ...
    \todo Split out Win32-specific socket stuff into a separate file.
*/
...
//! File descriptor that host makes available for others to connect into.
int public_fd;

//! Flag indicating whether 'public_fd' is currently valid.
int public_fd_valid;

//! Next ID for a remote program.
...
//! Corresponding array of validity flags for 'remote_fd' array.
int fd_valid[100];
