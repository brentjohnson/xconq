...
(game-module "all"
  ...
  (variants
   ...
   (sequential)
   (world-seen)
   ;; Must match the explicit area/world below, since the map is fixed.
   (world-size (30 25 1000))
   (economy)
   (people)
   (supply)
   )
...
(xxxunit 15 12 1 (a (add-terrain)))
;; Test transport references: id 3 is the named unit above.
(xxxunit 15 12 1 (in "CPT Socks"))

(xxxunit 15 12 1 (a (alter-terrain)))
(xxxunit 15 12 1 (a (attack)))
(xxxunit 15 12 1 (a (build)))
(xxxunit 15 12 1 (a (capture)))
(xxxunit 15 12 1 (a (change-side)))
(xxxunit 15 12 1 (a (change-type)))
(xxxunit 15 12 1 (a (create-at)))
(xxxunit 15 12 1 (a (create-in)))
(xxxunit 15 12 1 (a (detonate)))
(xxxunit 15 12 1 (a (disband)))
(xxxunit 15 12 1 (a (enter)))
(xxxunit 15 12 1 (a (extract)))
(xxxunit 15 12 1 (a (fire-at)))
(xxxunit 15 12 1 (a (fire-into)))
(xxxunit 15 12 1 (a (overrun)))
(xxxunit 15 12 1 (a (produce)))
(xxxunit 15 12 1 (a (remove-terrain)))
(xxxunit 15 12 1 (a (repair)))
(xxxunit 15 12 1 (a (develop)))
(xxxunit 15 12 1 (a (toolup)))
(xxxunit 15 12 1 (a (transfer)))

(xxxunit 15 12 1 (plan none))
(xxxunit 15 12 1 (plan offensive))
(xxxunit 15 12 1 (plan defensive))
(xxxunit 15 12 1 (plan exploratory))
(xxxunit 15 12 1 (plan colonizing))
(xxxunit 15 12 1 (plan improving))

(xxxunit 15 12 1 (plan offensive (goal 1 0 no-goal)))
(xxxunit 15 12 1 (plan offensive (goal 1 0 vicinity-is-known)))
(xxxunit 15 12 1 (plan offensive (goal 1 0 positions-known)))
(xxxunit 15 12 1 (plan offensive (goal 1 0 cell-is-occupied)))
(xxxunit 15 12 1 (plan offensive (goal 1 0 vicinity-is-held)))
(xxxunit 15 12 1 (plan offensive (goal 1 0 has-unit-type)))
(xxxunit 15 12 1 (plan offensive (goal 1 0 has-unit-type-near)))
(xxxunit 15 12 1 (plan offensive (goal 1 0 has-material-type)))
(xxxunit 15 12 1 (plan offensive (goal 1 0 keep-formation)))
(xxxunit 15 12 1 (plan offensive (goal 1 0 find-spot-to-build)))
